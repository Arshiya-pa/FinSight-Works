...
export default function SubDivisionTable({
    ...
    const [selectedStatusDivision, setSelectedStatusDivision] = useState(null);
    ...
    const totalRows = subDivisions.length;
                                ...
                                currentRows.map((division) => (
                                    <tr
                                       ...
                                       onClick={() =>
                                        ...
                                        className={`cursor-pointer border-b ${selectedSubDivision?.subdivision_id ===
                                                division.subdivision_id
                                    ...
                                    {/* parent division id */}
                                      <td className="px-2.5 py-1.5 text-center text-[10px] font-medium leading-tight text-gray-800">
                                        ...
                                        <td className="px-2.5 py-1.5 text-center">
                                            <span
                                                className={`inline-flex rounded-full px-1.5 py-0.5 text-[9px] font-medium leading-tight ${division.active
